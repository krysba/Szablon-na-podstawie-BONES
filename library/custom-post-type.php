...
function custom_post_example() { 
	...
	//register_taxonomy_for_object_type( 'category', 'custom_type','sesje_dzieciece' );
	/* this adds your post tags to your custom post type */
	//register_taxonomy_for_object_type( 'post_tag', 'custom_type' ,'sesje_dzieciece');

	// dodanie własnego typu postów
	// creating (registering) the custom type 
	register_post_type( 'sesje_dzieciece', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Sesje dziecięce', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Custom Post', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Custom Posts', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Custom Type', 'bonestheme' ), /* Add New Display Title */
			...
			'menu_position' => 8, /* this is what order you want it to appear in on the left hand side menu */ 
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/custom-post-icon.png', /* the icon for the custom post type menu */
			'rewrite'	=> array( 'slug' => 'sesje_dzieciece', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'sesje_dzieciece', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
	...
	*/
	...
	// doanie kategori itagów
	// now let's add custom categories (these act like categories)
	register_taxonomy( 'dzieciece_cat', 
		array('sesje_dzieciece'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				'name' => __( 'kategorie dzieciece', 'bonestheme' ), /* name of the custom taxonomy */
				'singular_name' => __( 'kategorie dzieciece', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Custom Categories', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Custom Categories', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Custom Category', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Custom Category:', 'bonestheme' ), /* parent taxonomy title */
			...
			'show_ui' => true,
			'query_var' => true,
			'rewrite' => array( 'slug' => 'dzieciece-slug' ),
		)
	);
	
	// now let's add custom tags (these act like categories)
	register_taxonomy( 'dzieciece_tag', 
		array('sesje_dzieciece'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => false,    /* if this is false, it acts like tags */
			'labels' => array(
				'name' => __( 'Sesje dzieciece', 'bonestheme' ), /* name of the custom taxonomy */
				'singular_name' => __( 'Sesje dzieciece', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Custom Tags', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Custom Tags', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Custom Tag', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Custom Tag:', 'bonestheme' ), /* parent taxonomy title */
